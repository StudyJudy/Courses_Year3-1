...
{
       0,    89,    89,    93,    94,    98,   104,   116,   128,   140,
     162,   170,   181,   182
};
#endif
...
#line 98 "expr5.y"
                                        {
                                            symTable.insert(any_cast<string>(yyvsp[-3]), any_cast<double>(yyvsp[-1]));
                                        }
#line 1223 "y.tab.c"
    break;
...
#line 104 "expr5.y"
                                        {//$$ = any_cast<double>($1) + any_cast<double>($3);
                                         // 获取表达式的值
                                         double leftValue = any_cast<double>(yyvsp[-2]);
                                         double rightValue = any_cast<double>(yyvsp[0]);
...
#line 140 "expr5.y"
                                        {//$$ = any_cast<double>($1) / any_cast<double>($3);
                                         ...
                                         if (rightValue == 0) 
                                         {
                                             ...
                                             yyval = 0.0; // 设置结果为零，或者您可以采取其他错误处理措施
                                         } 
                                         else 
                                         {
                                             // 执行除法操作并将结果存储在eax中
...
#line 162 "expr5.y"
                                        {//$$ = any_cast<double>($2);
                                         // 获取括号内表达式的值
                                         double exprValue = any_cast<double>(yyvsp[-1]);
...
#line 170 "expr5.y"
                                        {//$$ = -1 * any_cast<double>($2);
                                         // 获取表达式的值
                                         double exprValue = any_cast<double>(yyvsp[0]);
                                         ...
                                         // 将结果存储在$$中
                                         yyval = -exprValue; // 为了确保结果为负数，将表达式值取反
                                        }
#line 1330 "y.tab.c"
    break;
...
#line 182 "expr5.y"
                                        {
                                            string identifier = any_cast<string>(yyvsp[0]);
