...
B164:
  ...
  br label %B196
B196:                               	; preds = %B164, %B164, %B197
  %t34 = load i32, i32* %t195, align 4
  %t199 = icmp eq i32 %t34, 5
  br i1 %t199, label %B197, label %B198
B197:                               	; preds = %B196
...
B198:                               	; preds = %B196
  ...
  store i32 10, i32* %t201, align 4
  %t160 = load i32, i32* %t201, align 4
  call void @putch(i32 %t160)
  %t161 = load i32, i32* %t195, align 4
  call void @putint(i32 %t161)
  %t162 = load i32, i32* %t201, align 4
